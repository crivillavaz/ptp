...
<script>
   ...
   $.ajax({
        url: 'http://ptpsystem.net/Stages/obtener_lider',
        data: { 'lider' : lider},
        type: "post",
        cache: false,
        success: function (data) {
   ...
   $.ajax({
        url: 'http://ptpsystem.net/Stages/obtener_trabajadores',
        data: { 'trabajadores' : x},
        type: "post",
        cache: false,
        success: function (data) {
   ...
   $.ajax({
        url: 'http://ptpsystem.net/Stages/obtener_ehs',
        data: { 'ehs' : ehs},
        type: "post",
        cache: false,
        success: function (data) {
   ...
   $('#enviar').click(function() {
       ...
       $.ajax({
               type : 'POST',
               url  : 'http://ptpsystem.net/Stages/anadir',
               data : data,
             success :  function(data){
    ...
    $('#StepRiskId').on('change', function() {
         ...
         $.ajax({
             url: 'http://ptpsystem.net/Stages/opciones',
             data: { 'riesgo' : riesgo},
             type: "post",
             cache: false,
             success: function (data) {
     ...
     $('#enviar_paso').click(function() {
          ...
          $.ajax({
                  type : 'POST',
                  url: 'http://ptpsystem.net/Stages/etapas',
                  data : datos,
                success :  function(data){
