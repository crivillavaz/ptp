      ...
      <div class="permissions form">
        ...
        <fieldset>
          ...
          <div class="form-group col-md-12">
            ...
            <?php echo $this->Form->input('nombre', array('class' => 'form-control', 'placeholder' => '','label' => 'Area general de trabajo')); ?>
          </div>
        </fieldset>
        <?php $options = array('class' => 'btn btn-primary', 'label' => 'Editar área'); ?>
	 <br />
