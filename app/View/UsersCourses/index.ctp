<div class="usersCourses index">
	<h2><?php echo __('Users Courses'); ?></h2>
	...
	<tr>
		...
		<td><?php echo h($usersCourse['UsersCourse']['user_id']); ?>&nbsp;</td>
		<td><?php echo h($usersCourse['UsersCourse']['course_id']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $usersCourse['UsersCourse']['id']), array(), __('Are you sure you want to delete # %s?', $usersCourse['UsersCourse']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
