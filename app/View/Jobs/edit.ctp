<div class="page-title">
  <h3>Tipo de trabajo Peligroso</h3>
</div>
<div id="main-wrapper">
  <div class="col-md-9">
      ...
      <div class="permissions form">
        ...
        <fieldset>
          ...
          <div class="form-group col-md-12">
            ...
            <?php echo $this->Form->input('nombre', array('class' => 'form-control', 'placeholder' => '','label' => 'Tipo de trabajo')); ?>
          </div>
        </fieldset>
        <?php $options = array('class' => 'btn btn-primary', 'label' => 'Editar tipo de trabajo'); ?>
	 <br />
